                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="ml-6 flex items-center space-x-4">
                            <a href="search.php" class="text-white hover:text-indigo-100 px-3 py-2 rounded-md text-sm font-medium <?php echo ($current_page == 'search.php') ? 'bg-indigo-700' : ''; ?>">
                                <i class="fas fa-search mr-1"></i> Cari
                            </a>
                            <a href="my_applications.php" class="text-white hover:text-indigo-100 px-3 py-2 rounded-md text-sm font-medium <?php echo ($current_page == 'my_applications.php' || $current_page == 'view_application.php') ? 'bg-indigo-700' : ''; ?>">
                                <i class="fas fa-clipboard-list mr-1"></i> Lamaran
                            </a>
                            <a href="certificates.php" class="text-white hover:text-indigo-100 px-3 py-2 rounded-md text-sm font-medium <?php echo ($current_page == 'certificates.php' || $current_page == 'generate_certificate.php') ? 'bg-indigo-700' : ''; ?>">
