                ...
                <div class="flex justify-between h-16 items-center">
                    ...
                    <div class="flex-grow flex justify-center">
                        <div class="hidden md:flex items-center space-x-2">
                            <a href="index.php" class="text-[#10283f] hover:text-gray-600 px-3 py-2 rounded-md text-sm font-medium relative group <?php echo ($current_page == 'index.php') ? 'bg-gray-100' : ''; ?>">
                            ...
                            <a href="create_activity.php" class="text-[#10283f] hover:text-gray-600 px-3 py-2 rounded-md text-sm font-medium relative group <?php echo ($current_page == 'create_activity.php' || $current_page == 'edit_activity.php') ? 'bg-gray-100' : ''; ?>">
                                <span class="absolute inset-0 bg-gray-100 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                                <span class="relative">Buat</span>
                            </a>
                            <a href="manage_activities.php" class="text-[#10283f] hover:text-gray-600 px-3 py-2 rounded-md text-sm font-medium relative group <?php echo (in_array($current_page, ['manage_activities.php', 'view_applications.php', 'generate_certificates.php'])) ? 'bg-gray-100' : ''; ?>">
                                <span class="absolute inset-0 bg-gray-100 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                                <span class="relative">Kelola</span>
                            </a>
                    ...
                    <div class="flex items-center justify-end w-1/4">
                        <span class="text-[#10283f] mr-4 hidden md:inline">Hello, <?php echo htmlspecialchars($owner_name); ?></span>
        ...
        <div id="mobileMenu" class="fixed inset-0 bg-[#10283f]/95 z-50 transform translate-x-full transition-transform duration-300 md:hidden">
            <div class="flex flex-col h-full p-6">
                ...
                <div class="flex flex-col space-y-4">
                    <a href="index.php" class="text-white hover:bg-[#10283f]/80 px-4 py-3 rounded-lg text-lg font-medium flex items-center <?php echo ($current_page == 'index.php') ? 'bg-[#10283f]/80' : ''; ?>">
                        Dashboard
                    </a>
                    <a href="create_activity.php" class="text-white hover:bg-[#10283f]/80 px-4 py-3 rounded-lg text-lg font-medium flex items-center <?php echo ($current_page == 'create_activity.php' || $current_page == 'edit_activity.php') ? 'bg-[#10283f]/80' : ''; ?>">
                        Buat
                    </a>
                    <a href="manage_activities.php" class="text-white hover:bg-[#10283f]/80 px-4 py-3 rounded-lg text-lg font-medium flex items-center <?php echo (in_array($current_page, ['manage_activities.php', 'view_applications.php', 'generate_certificates.php'])) ? 'bg-[#10283f]/80' : ''; ?>">
                        Kelola
                    </a>
                    ...
                    <div class="mt-auto pt-10">
                        <p class="text-white mb-4">Hello, <?php echo htmlspecialchars($owner_name); ?></p>
