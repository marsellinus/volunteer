...
<head>
    ...
    <style>
        ...
        .certificate {
            ...
            border: 20px solid #10283f;
            background-color: #fff;
            font-family: 'Montserrat', sans-serif;
            color: #333;
            background-image: linear-gradient(135deg, rgba(16, 40, 63, 0.1) 25%, transparent 25%, transparent 50%, rgba(16, 40, 63, 0.1) 50%, rgba(16, 40, 63, 0.1) 75%, transparent 75%, transparent);
...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto py-8 px-4">
        <div class="mb-6 flex justify-between items-center">
            <a href="certificates.php" class="inline-flex items-center text-sm text-gray-600 hover:text-gray-500">
                <i class="fas fa-arrow-left mr-1"></i> Kembali ke daftar piagam
            </a>
            
            <button onclick="printCertificate()" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-gray-800 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
