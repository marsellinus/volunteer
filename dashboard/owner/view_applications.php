...
// Set page title
$page_title = 'Pendaftar Kegiatan - VolunteerHub';
...
<main class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 pt-20 mt-10">
    <div class="mb-6">
        <a href="manage_activities.php" class="inline-flex items-center text-sm text-#10283f hover:text-#10283f">
            <i class="fas fa-arrow-left mr-1"></i> Kembali ke daftar kegiatan
        </a>
    </div>

    <!-- Activity Summary -->
    <div class="bg-[#10283f] shadow overflow-hidden sm:rounded-lg mb-6">
        <div class="px-4 py-5 sm:px-6 bg-gradient-to-r from-#10283f to-#10283f text-white">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-lg leading-6 font-medium">Pendaftar Kegiatan</h3>
                    <p class="mt-1 max-w-2xl text-sm text-#10283f-100">
                        <?php echo htmlspecialchars($activity['title']); ?>
                    </p>
                </div>
                <div class="text-right">
                    <p class="text-sm text-#10283f-100">
                        <i class="far fa-calendar-alt mr-1"></i> <?php echo date('d F Y', strtotime($activity['event_date'])); ?>
                    </p>
                    <p class="text-xs text-#10283f-200 mt-1">
        ...
        <div class="px-4 py-4 sm:px-6 bg-gray-50 border-b border-gray-200">
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center">
                <div class="flex space-x-2 mb-4 sm:mb-0">
                    <span class="inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium bg-#10283f-100 text-#10283f-800">
                ...
                <div>
                    <a href="generate_certificates.php?activity_id=<?php echo $activity_id; ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-#10283f hover:bg-#10283f focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-#10283f">
    ...
    <div class="border-b border-gray-200 mb-6">
        <nav class="-mb-px flex" aria-label="Tabs">
            <a href="view_applications.php?activity_id=<?php echo $activity_id; ?>&filter=all" class="<?php echo $filter == 'all' ? 'border-#10283f text-#10283f' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'; ?> whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm mr-8">
                Semua Pendaftar
            </a>
            <a href="view_applications.php?activity_id=<?php echo $activity_id; ?>&filter=pending" class="<?php echo $filter == 'pending' ? 'border-#10283f text-#10283f' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'; ?> whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm mr-8">
                Menunggu Review
            </a>
            <a href="view_applications.php?activity_id=<?php echo $activity_id; ?>&filter=approved" class="<?php echo $filter == 'approved' ? 'border-#10283f text-#10283f' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'; ?> whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm mr-8">
                Diterima
            </a>
            <a href="view_applications.php?activity_id=<?php echo $activity_id; ?>&filter=rejected" class="<?php echo $filter == 'rejected' ? 'border-#10283f text-#10283f' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'; ?> whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                Ditolak
            </a>
        </nav>
    </div>
                    ...
                    <div class="px-4 py-4 sm:px-6">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <div class="text-sm font-medium text-#10283f"><?php echo htmlspecialchars($application['user_name']); ?></div>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="mt-3 text-sm text-gray-700">
                                <button type="button" onclick="toggleMessage('message-<?php echo $application['id']; ?>')" class="text-#10283f hover:text-#10283f focus:outline-none flex items-center">
                        ...
                        <div class="mt-4 flex flex-col sm:flex-row sm:justify-end">
                            <form method="POST" action="view_applications.php?activity_id=<?php echo $activity_id; ?>" class="mt-2 sm:mt-0 sm:ml-3 flex">
                                ...
                                <select name="status" class="mr-2 block w-full sm:w-auto pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-#10283f focus:border-#10283f sm:text-sm rounded-md">
                                ...
                                <button type="submit" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-#10283f hover:bg-#10283f focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-#10283f">
                                    Perbarui
                                </button>
                            </form>
                        </div>
