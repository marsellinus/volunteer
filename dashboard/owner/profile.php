    ...
    <div class="md:grid md:grid-cols-3 md:gap-6">
        ...
        <div class="md:col-span-1">
            <div class="bg-white shadow overflow-hidden sm:rounded-lg mb-6">
                <div class="px-4 py-5 sm:px-6 bg-gradient-to-r from-[#10283f] to-[#1c425f] text-white">
                    <h3 class="text-lg font-medium">Profil Organisasi</h3>
                    <p class="mt-1 text-sm text-gray-100">Informasi tentang organisasi Anda</p>
                </div>
                <div class="border-t border-gray-200 px-4 py-5 sm:p-6">
                    <div class="flex items-center mb-4">
                        <div class="flex-shrink-0 h-20 w-20 rounded-full bg-[#e8f0f7] flex items-center justify-center text-[#10283f] text-2xl">
                        ...
                        <div class="ml-4">
                            ...
                            <a href="<?php echo htmlspecialchars($owner['website']); ?>" target="_blank" class="text-sm text-[#10283f] hover:text-[#1c425f]">
                    ...
                    <div class="mt-6">
                        ...
                        <dl class="grid grid-cols-2 gap-x-4 gap-y-6">
                            <div class="border-l-4 border-[#10283f] pl-2">
                ...
                <div class="border-t border-gray-200 px-4 py-5 sm:p-6">
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <input type="text" name="name" id="name" value="<?php echo htmlspecialchars($owner['name']); ?>" required class="mt-1 focus:ring-[#10283f] focus:border-[#10283f] block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>

                        <div class="col-span-6 sm:col-span-4">
                            <label for="organization_name" class="block text-sm font-medium text-gray-700">Nama Organisasi</label>
                            <input type="text" name="organization_name" id="organization_name" value="<?php echo htmlspecialchars($owner['organization_name'] ?? ''); ?>" required class="mt-1 focus:ring-[#10283f] focus:border-[#10283f] block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>

                        <div class="col-span-6">
                            <label for="organization_description" class="block text-sm font-medium text-gray-700">Deskripsi Organisasi</label>
                            <textarea id="organization_description" name="organization_description" rows="4" class="mt-1 shadow-sm focus:ring-[#10283f] focus:border-[#10283f] block w-full sm:text-sm border-gray-300 rounded-md"><?php echo htmlspecialchars($owner['organization_description'] ?? ''); ?></textarea>
                            <p class="mt-2 text-sm text-gray-500">Jelaskan tentang organisasi Anda, visi, misi, dan fokus kegiatannya.</p>
                        </div>

                        <div class="col-span-6 sm:col-span-4">
                            <label for="website" class="block text-sm font-medium text-gray-700">Website</label>
                            <input type="url" name="website" id="website" value="<?php echo htmlspecialchars($owner['website'] ?? ''); ?>" class="mt-1 focus:ring-[#10283f] focus:border-[#10283f] block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="https://www.example.org">
                        </div>
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <input type="password" name="current_password" id="current_password" class="mt-1 focus:ring-[#10283f] focus:border-[#10283f] block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>

                        <div class="col-span-6 sm:col-span-4">
                            <label for="new_password" class="block text-sm font-medium text-gray-700">Password Baru</label>
                            <input type="password" name="new_password" id="new_password" class="mt-1 focus:ring-[#10283f] focus:border-[#10283f] block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>

                        <div class="col-span-6 sm:col-span-4">
                            <label for="confirm_password" class="block text-sm font-medium text-gray-700">Konfirmasi Password Baru</label>
                            <input type="password" name="confirm_password" id="confirm_password" class="mt-1 focus:ring-[#10283f] focus:border-[#10283f] block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>
                    </div>
                </div>
                <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                    <button type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-[#10283f] hover:bg-[#1c425f] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#10283f]">
