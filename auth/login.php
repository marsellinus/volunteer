...
<head>
    ...
    <style>
        ...
        input:focus {
            ...
            box-shadow: 0 0 0 1px #10283f !important;
            z-index: 10 !important;
        }
        
        /* Custom color for radio buttons when checked */
...
<body class="bg-gray-100">
    <div class="login-container flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        <!-- Login Form -->
        <div class="login-form-container max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-xl bg-opacity-95">
            <div>
            ...
            <form class="mt-8 space-y-6" action="login.php" method="POST">
                ...
                <div>
                    <button type="submit" class="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-md text-white transition-colors duration-200" style="background-color: #10283f; hover:background-color: #1a3b58; focus:ring-color: #10283f;">
            ...
            <div class="text-center">
                <p class="mt-2 text-center text-sm text-gray-600">
                    Belum memiliki akun?
                    <a href="register.php" class="font-medium hover:text-opacity-80" style="color: #10283f;">
                        Daftar sekarang
                    </a>
                </p>
                <p class="mt-2 text-center text-sm text-gray-600">
