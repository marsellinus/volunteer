...
<body class="bg-gray-50">
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    <div class="flex-shrink-0 flex items-center">
                        <a href="index.php" class="text-xl font-bold text-indigo-600">VolunteerHub</a>
                    </div>
                </div>
    ...
    <main class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
            <a href="index.php" class="inline-flex items-center text-sm text-indigo-600 hover:text-indigo-500">
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            ...
            <div class="border-t border-gray-200 px-4 py-5 sm:px-6">
                <?php if(isset($_SESSION['user_id'])): ?>
                    <a href="../dashboard/user/view_activity.php?id=<?php echo $activity_id; ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700">
                        Apply Now
                    </a>
                <?php else: ?>
                    <div class="bg-gray-50 p-4 rounded-md">
                        ...
                        <div class="mt-3">
                            <a href="../auth/login.php" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200">
                                Login
                            </a>
                            <a href="../auth/register.php" class="ml-3 inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
                                Register
                            </a>
                        </div>
                    </div>
